...
program
    ...
    .option('-h, --headless [type]', 'run the test in a headless mode')
    .parse(process.argv);

program.on('--help', function () {
    console.log('  For more details please visit https://github.com/ShablaLab/selenium-cucumberjs-pageobject-applitools-demo#readme\n');
});
...
global.DEFAULT_TIMEOUT = global.DEFAULT_TIMEOUT || program.timeOut || 10 * 9000;
...
global.browserHeadless = (program.opts().headless == undefined) ? false : true;
