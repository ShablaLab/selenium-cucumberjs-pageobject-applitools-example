...
module.exports = {
    ...
    waitForElementLocated: async function (elementSelector, waitInMilliseconds) {
        // use either passed in timeout or global default
        var timeout = waitInMilliseconds || DEFAULT_TIMEOUT;

        await driver.wait(until.elementLocated(elementSelector), timeout);
        await driver.wait(until.elementIsVisible(driver.findElement(elementSelector)), timeout);
    },
    /**
