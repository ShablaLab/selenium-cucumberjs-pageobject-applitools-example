...
// drivers
var FireFoxDriver = require('./firefoxDriver');
...
module.exports = function () {
    ...
    this.registerHandler('BeforeScenario', function (scenario) {
        ...
        if (global.eyesKey !== '') {
            ...
            global.scenarioName = scenario.getName();
            eyes.open(global.driver, 'selenium-cucumberjs-pageobject-applitools-example', global.scenarioName, { width: 1280, height: 800 });
        }
    });
    ...
    this.After(function (scenario) {
        ...
        return driver.takeScreenshot().then(function (screenShot) {
            ...
            scenario.attach(new Buffer.from(screenShot, 'base64'), 'image/png');
